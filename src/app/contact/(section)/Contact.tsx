            ...
            <div className="flex w-full flex-col gap-6 px-3 lg:w-3/5 lg:px-0">
              <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://maps.app.goo.gl/n1vMmWCWVSrWUpwE7">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-4 break-all">
                  <Link href="mailto:info@hitchki.co.uk">info@hitchki.co.uk</Link>
                </div>
              </div>
            </div>
