      ...
      <div className="relative flex min-h-[100vh] w-full items-center justify-center bg-black">
        ...
        <div className="z-40 flex h-full w-full max-w-[1300px] items-center justify-center">
          <div className="head-container flex w-fit flex-col items-center justify-center gap-7">
            <h1 className="head-hero text-center font-arvo text-5xl font-semibold text-[#fff4e3] sm:text-5xl md:text-8xl lg:leading-[110px]">
              Experience the <br /> Authentic Turkish<br /> Mangal Restaurant
            </h1>
            <Link href="/menu">
              <Button className="hero-button flex items-center justify-center gap-3 rounded-full px-6 py-7 bg-primary hover:bg-secondary hover:text-black">
                View Menu <MoveRight />
              </Button>
            </Link>
          </div>
