    ...
    <section className="relative flex h-full w-full justify-center bg-[#070707]">
      <div className="flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-6 py-12">
        <div className="w-full flex flex-col justify-center items-center gap-3">
          <h3 className="special-title font-inter uppercase italic -ml-[50px] text-xl text-[#D3AF39]">Special</h3>
          <h1 className="special-head max-w-[600px] text-center font-arvo font-bold text-5xl sm:text-6xl">
            Hitchki{' '}<span className="text-primary">Specials</span>
          </h1>
        </div>
        {modelData && (
